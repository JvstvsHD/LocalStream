...
import de.jvstvshd.localstream.network.handling.PacketHandler;
...
public abstract class Packet<Handler extends PacketHandler> implements PacketComparable<Packet<?>> {
     ...
     * @param handler Handler - often a implementation of {@link de.jvstvshd.localstream.network.handling.PacketClientHandler} or {@link de.jvstvshd.localstream.network.handling.PacketServerHandler}.
     * @see PacketHandler
     * @see de.jvstvshd.localstream.network.handling.PacketClientHandler
     * @see de.jvstvshd.localstream.network.handling.PacketServerHandler
     */
